...
//
//        //        class Cell(private var brightness: Double, private var color: ColorRGBa)
...
//
//        extend {
//            currentImg = imgs[(frameCount*0.1).toInt() % imgs.size]
//
...
//                    val thisCell = Cell(brightness, currentColor)
//                    brightnessValues[i][j] = thisCell
//                }
//            }
//
...
//            for (i in 0 until gridWidth) {
//                for (j in 0 until gridHeight) {
//                    var tempW = brightnessValues[i][j].brightness.map(
//                        0.0,
//                        1.0,
//                        0.0,
//                        cellWidth.toDouble()
