...
//import org.openrndr.extra.color.presets.LIGHT_CYAN
...
//
//        }
//        val cellArray = Array(gridWidth.toInt()) { Array(gridHeight.toInt()) { Cell() } }
//        class Flag {
//            var storedTime: Int
//            var counter: Int
...
////                println(brightness)
//                cellArray[i][j].id = idIncrementor++.toString() //   i can move this to the main block
//                cellArray[i][j].brightness = brightness
//                cellArray[i][j].color = currentColor.toSRGB()
//                cellArray[i][j].position = Vector2((i * cellWidth), (j * cellHeight))
//            }
...
//
//            indices.forEach { (i, j) ->
//                if(cellArray[i][j].brightness < 0.2){
//                    circleListLight.add(
//                        Circle(
//                            cellArray[i][j].position.x,
//                            cellArray[i][j].position.y,
//                            cellArray[i][j].renderW * shapeScaler
//                        )
//                    )
//                } else {
//                    circleListDark.add(
...
//                }
//            }
////            println(circleListLight.size)
//            drawer.stroke = null
//            drawer.pushTransforms()
////            drawer.translate(circleListLight[0].radius * 2, circleListLight[0].radius * 2)
//            drawer.fill = ColorRGBa.LIGHT_CYAN
//            drawer.circles(circleListLight)
//            drawer.fill = ColorRGBa.DARK_BLUE
