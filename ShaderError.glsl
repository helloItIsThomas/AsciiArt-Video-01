...
void main(void) {
    ...
    vec4 x_stroke = vi_stroke;
    {
                    ...
                    void main() {
                      ...
                      // Sample the brightness value at the UV coordinates
                      float brightness = texture(sampler, uv).r;
                      // Set the output color with the brightness value
...
// -------------
// shade-style-custom:rectangle--1700123645
// created 2023-06-08T19:02:41.396212
/*
ERROR: 0:71: '' :  #version must occur before any other statement in the program
ERROR: 0:75: '{' : syntax error: syntax error
*/
